...
public class PowerupInventory : MonoBehaviour
{
	...
	public void AddPowerup(string name, int powerupId, int objectId)
	{
		...
		ParticleSystem component = Object.Instantiate<GameObject>(this.powerupFx, position, Quaternion.identity).GetComponent<ParticleSystem>();
		component.main.startColor = ItemManager.Instance.allPowerups[powerupId].GetOutlineColor();
