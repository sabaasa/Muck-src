...
public class OtherInput : MonoBehaviour
{
	...
	{
		return this.pauseUi.activeInHierarchy || this.settingsUi.activeInHierarchy || ChatBox.Instance.typing || Map.Instance.active || (RespawnTotemUI.Instance.root.activeInHierarchy || TraderUI.Instance.root.activeInHierarchy) || (InventoryUI.Instance.gameObject.activeInHierarchy && this.craftingState != OtherInput.CraftingState.Inventory);
	}
