...
public class Arrow : MonoBehaviour
{
	...
	private void StopArrow(Collision other)
	{
		...
		Object.Destroy(this);
		Object.Destroy(this.audio);
		this.trail.emitting = false;
		Vector3 position = base.transform.position;
		Vector3 forward = -base.transform.forward;
		ParticleSystem component = Object.Instantiate<GameObject>(this.hitFx, position, Quaternion.LookRotation(forward)).GetComponent<ParticleSystem>();
