...
{
	public static int FindRandomUnusedID(InventoryItem.ItemType item, Dictionary<int, GameObject> list, Random random)
	{
	...
	{
		int num = 10000;
		int num2 = (int)(item * (InventoryItem.ItemType)10000);
