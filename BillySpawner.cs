...
public class BillySpawner : MonoBehaviour
{
	...
	private void Start()
	{
		...
		foreach (BillySpawner.WeightedSpawn weightedSpawn in this.structurePrefabs)
		{
	...
	public GameObject FindObjectToSpawn(BillySpawner.WeightedSpawn[] structurePrefabs, float totalWeight)
	{
