...
public class ItemManager : MonoBehaviour
{
	...
	{
		GameObject gameObject = Object.Instantiate<GameObject>(this.dropItem);
		...
		{
			GameObject gameObject2 = Object.Instantiate<GameObject>(this.debug, gameObject.transform);
	...
	{
		Object.Destroy(this.list[objectID]);
