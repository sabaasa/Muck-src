...
public class LaserTest : MonoBehaviour
{
	...
	private void OnEnable()
	{
		...
		base.Invoke("StopLaser", 2.1f);
		this.hitParticles.gameObject.SetActive(true);
		base.InvokeRepeating("DamageEffect", this.damageUpdateRate, this.damageUpdateRate);
	}
	...
	{
		Object.Instantiate<GameObject>(this.damageFx, this.hitParticles.transform.position, this.hitParticles.transform.rotation);
	}
