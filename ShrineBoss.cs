...
public class ShrineBoss : MonoBehaviour, SharedObject, Interactable
{
	...
	{
		this.started = true;
		Object.Instantiate<GameObject>(this.destroyShrineFx, base.transform.position, this.destroyShrineFx.transform.rotation);
		base.Invoke("RemoveFromResources", 1.33f);
	}

	public void ServerExecute(int fromClient)
	{
		this.started = true;
		base.Invoke("SpawnBoss", 1.3f);
		Object.Instantiate<GameObject>(this.destroyShrineFx, base.transform.position, this.destroyShrineFx.transform.rotation);
