...
public class Boat : MonoBehaviour
{
	...
	private void Start()
	{
		...
		Boat.Instance = this;
		base.InvokeRepeating("CheckFound", 0.5f, 1f);
		this.boatPing = Object.Instantiate<GameObject>(this.objectivePing, base.transform.position, Quaternion.identity).GetComponent<ObjectivePing>();
	...
	public void LeaveIsland()
	{
		...
		this.sinking = true;
		Object.Destroy(this.wheelInteract.gameObject);
		Object.Destroy(this.wheelPing.gameObject);
	...
	public void FindShip()
	{
		...
		Object.Destroy(this.boatPing.gameObject);
