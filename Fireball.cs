...
public class Fireball : MonoBehaviour
{
	private void Start()
	{
		...
		{
			EnemyAttackIndicator component2 = Object.Instantiate<GameObject>(this.warningFx, raycastHit.point, this.warningFx.transform.rotation).GetComponent<EnemyAttackIndicator>();
