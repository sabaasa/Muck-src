...
public class MusicController : MonoBehaviour
{
	...
	{
		if (GameManager.instance && GameManager.instance.boatLeft && s != MusicController.SongType.Bob)
		{
			return;
		}
	...
	public void FinalBoss()
	{
		...
		this.StartFade(this.audio, num, 0f);
		base.Invoke("BobTheme", num);
	}
